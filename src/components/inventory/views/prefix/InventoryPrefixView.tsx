            ...
            <div className="flex flex-col justify-between col-span-5 overflow-auto">
                { activePrefix &&
                    <div className="flex flex-col gap-1">
                        <span className="text-sm truncate min-h-[1.25rem] leading-5">Prefix attivo</span>
                ...
                { !activePrefix &&
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center justify-center p-3 rounded-md border-2 border-dashed border-card-grid-item-border bg-card-grid-item opacity-50">
                            <span className="text-sm">Nessun prefix attivo</span>
                        </div>
                    </div> }
                { !!selectedPrefix &&
                    <div className="flex flex-col gap-2 mt-2">
                        ...
                        <div className="flex items-center gap-2">
                            <NitroButton
                                ...
                                { selectedPrefix.active ? 'Disattiva' : 'Attiva' }
                            </NitroButton>
