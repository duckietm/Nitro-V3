...
export const UserSettingsView: FC<{}> = (props) => {
    ...
    return (
        <NitroCardView
            className="user-settings-window min-w-0 max-w-[calc(100vw-16px)] max-h-[calc(100vh-16px)]"
            theme="primary-slim"
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                {userSettings.volumeSystem === 0 && (
                                    <FaVolumeMute className={classNames(userSettings.volumeSystem >= 50 && 'text-muted', 'fa-icon')} />
                                )}
                                {userSettings.volumeSystem > 0 && (
                                    <FaVolumeDown className={classNames(userSettings.volumeSystem >= 50 && 'text-muted', 'fa-icon')} />
                                )}
                                <input
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                {userSettings.volumeFurni === 0 && (
                                    <FaVolumeMute className={classNames(userSettings.volumeFurni >= 50 && 'text-muted', 'fa-icon')} />
                                )}
                                {userSettings.volumeFurni > 0 && (
                                    <FaVolumeDown className={classNames(userSettings.volumeFurni >= 50 && 'text-muted', 'fa-icon')} />
                                )}
                                <input
                                    className="custom-range w-full"
                                    id="volumeFurni"
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                {userSettings.volumeTrax === 0 && (
                                    <FaVolumeMute className={classNames(userSettings.volumeTrax >= 50 && 'text-muted', 'fa-icon')} />
                                )}
                                {userSettings.volumeTrax > 0 && (
                                    <FaVolumeDown className={classNames(userSettings.volumeTrax >= 50 && 'text-muted', 'fa-icon')} />
                                )}
                                <input
                                    className="custom-range w-full"
                                    id="volumeTrax"
