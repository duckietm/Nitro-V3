            ...
            { isVisible &&
                <NitroCardView classNames={ [ 'nitro-catalog-window' ] } isResizable={ false } uniqueKey="catalog">
                            ...
                            return (
                                <NitroCardTabsItemView key={ `${ child.pageId }-${ child.pageName }-${ index }` } isActive={ child.isActive } onClick={ () =>
                                {
                                    ...
                                    <div className={ `flex items-center gap-1 ${ isHidden ? 'opacity-40' : '' }` }>
                                        { (child.iconId > 0) &&
                                            <CatalogIconView icon={ child.iconId } className="nitro-catalog-tab-icon" /> }
                    ...
                    <div className="nitro-catalog-swf-header">
                        <div className="nitro-catalog-swf-header-bg" style={ currentPage?.localization?.getImage(0) ? { backgroundImage: `url(${ currentPage.localization.getImage(0) })` } : undefined } />
                        ...
                        <div className="nitro-catalog-swf-header-copy">
                            ...
                            { currentType === CatalogType.BUILDER
                                ...
                                : <div className="nitro-catalog-swf-header-description" dangerouslySetInnerHTML={ { __html: SanitizeHtml(currentPage?.localization?.getText(0) || '') } } /> }
                        </div>
                    </div>
